...
const BMICalculator = () => {
  ...
  const calculateBMI = (e) =>{
    ...
    if(bmiValue < 18.5){
      toast.warning("You are underweight. Consider seeking advice form a healthcare provider");
    }
      ...
      toast.error(
        "You are in the obese range. It is recommended to seek advice from a healthcare special."
      );
    }
  };
  return (
